    ...
    <section>
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-4 d-flex">
                ...
                <div class=" m-5 p-5">
                    <div class="">
                        <img class="mx-auto d-block" src="img/logo_1.0.png" width="80%" alt="">
                    </div>
                    <div class="m-2">
                        <h2>Contactanos via correo electronico o Telefono Celular</h2>
                        <P>
                            22-22-22-22-22
                        </P>
                    </div>
            ...
            <div class="col-lg-3 ">
                <div>
                    <img class="mx-auto d-block" src="img/contact.png" width="75%" alt="" class="img-fluid">
                </div>
                ...
                <div class="row borde bg-dark" style="justify-content: center;">
                        ...
                        <div class="card m-3">
                            <div class="card-header">
                                <h3 class="text-dark">www.ArteLocal.com</h4>
                            </div>
                        </div>
                        <form class="card-body" action="send_contact.php" method="POST" id="usuario-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mt-2" name="num" placeholder="22-22-22-22-22" id="correo" maxlength="10" pattern="[0-9]" required>
                            </div>
                            
                            <div class="form-group">
                                <textarea class="form-control mt-2" name="message" rows="4" cols="50" placeholder="Ingresa tu mensaje aqui" pattern="[A-Za-z0-9_-@.]" require></textarea>
                            </div>

                            <div class="d-grid gap-2 col-8 mx-auto">
                                <input type="submit" id="Enviar" class="btn btn-primary btn-block mt-2" value="Enviar">
                            </div>
                        </form>
                </div>
